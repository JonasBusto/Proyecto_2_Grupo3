                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body container d-flex flex-column align-items-center">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <button type="button" class="mx-4 btn" id="btnEliminarUsuario1">
                                    Eliminar
                                </button>
                            </div>
                        </div>
...
// Inhabilitar el administrador para eliminación y modificacion de nombre de usuario



// Función Modificar Usuario
// const modificarusuario = document.getElementById(`modalModificarusuario${usuario.id}`);
